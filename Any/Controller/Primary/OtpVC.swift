...
extension OtpVC {
    ...
    func WebSignUp() {
        ...
        CommunicationManeger.uploadImagesAndData(apiUrl: Router.signUp.url(), params: (paramSignupDict as! [String : String]) , imageParam: [:], videoParam: [:], parentViewController: self, successBlock: { (responseData, message) in
