...
extension ResetPasswordVC {
    ...
    func checkResestPassword() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.reset_password.url(), parameters: paramsDict,  parentViewController: self, successBlock: { (responseData, message) in
