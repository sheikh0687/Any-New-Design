...
class UserRatingVC: UIViewController {
    ...
    func WebGetReview() {
        ...
        print(paramsDict)
        CommunicationManeger.callPostService(apiUrl: Router.get_rating_review.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
