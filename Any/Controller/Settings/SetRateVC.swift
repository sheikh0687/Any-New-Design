...
extension SetRateVC {
    ...
    func WebGetShiftStatus() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_client_weekly_rate.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
...
//                    let arr = self.arr_AllWeekRate.filter({$0["check_status"].stringValue == "Yes"})
    ...
    func WebGetDateRate() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_client_date_rate.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func WebAddShift() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.add_client_weekly_rate.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func WebUpdateDateShifts() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.update_client_date_rate.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func WebDeleteDateRate(_ dateiD:String) {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.delete_client_date_rate.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
