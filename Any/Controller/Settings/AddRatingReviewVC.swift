...
class AddRatingReviewVC: UIViewController {
    ...
    func WebAddReview() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.add_user_rating_review.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
