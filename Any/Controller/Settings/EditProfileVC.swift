...
extension EditProfileVC {
    ...
    func GetClientInstruction() {
        ...
        CommunicationManeger.callPostApi(apiUrl: Router.get_country_details.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func WebGetCategoryjobType() {
        ...
        print(paramsDict)
        CommunicationManeger.callPostService(apiUrl: Router.get_job_type.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func WebUpdateClientProfile() {
        ...
        CommunicationManeger.uploadImagesAndData(apiUrl: Router.update_profile_client.url(), params: (paramsDict as! [String : String]) , imageParam: paramImgDict, videoParam: [:], parentViewController: self, successBlock: { (responseData, message) in
    ...
    func WebUpdateWorkerProfile() {
        ...
        CommunicationManeger.uploadImagesAndData(apiUrl: Router.update_profile_worker.url(), params: (paramsDict as! [String : String]) , imageParam: paramImgDict, videoParam: [:], parentViewController: self, successBlock: { (responseData, message) in
