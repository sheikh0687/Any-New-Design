...
class PaymentVC: UIViewController {
    ...
    func getCustomerId() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.create_Customer.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
