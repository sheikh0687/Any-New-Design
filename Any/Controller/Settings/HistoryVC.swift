...
extension HistoryVC {
    ...
    func WebGetApprovedBooking() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_shift_complete_by_client.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
