...
extension SetCustomDateRateVC {
    ...
    func WebAddShift() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.add_client_date_rate.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
