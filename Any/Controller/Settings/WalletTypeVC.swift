...
extension WalletTypeVC {
    ...
    func UpdatePaymentMethod() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.update_request_payment_type.url(), parameters: paramDict, parentViewController: self, successBlock: { (responseData, message) in
