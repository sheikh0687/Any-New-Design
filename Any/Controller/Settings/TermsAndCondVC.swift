...
class TermsAndCondVC: UIViewController {
    ...
    func CheckEmailStatus() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_user_page.url(), parameters: paramsDict,  parentViewController: self, successBlock: { (responseData, message) in
