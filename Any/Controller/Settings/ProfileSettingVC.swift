...
extension ProfileSettingVC {
    ...
    func deleteAccount() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.delete_Account.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
