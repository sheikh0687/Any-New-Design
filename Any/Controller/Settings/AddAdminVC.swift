...
class AddAdminVC: UIViewController {
    ...
    func CheckEmailStatus() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.add_OutletAdmin_AuthrisedApprover.url(), parameters: paramsDict,  parentViewController: self, successBlock: { (responseData, message) in
