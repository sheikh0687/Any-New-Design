...
extension UpdateJobPublishVC {
    ...
    func WebGetBookingDetails() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_set_shift_details.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func webUpdateJobPost()
    {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.update_my_shifts.url(), parameters: paramsDict,  parentViewController: self, successBlock: { (responseData, message) in
