...
class PopUpVC: UIViewController {
    ...
    func getDataGetList() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.add_client_date_wise_open_close.url(), parameters: paramDict, parentViewController: self, successBlock: { (responseData, message) in
