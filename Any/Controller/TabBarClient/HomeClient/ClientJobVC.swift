...
extension ClientJobVC {
    ...
    func GetNotificationCount() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_notification_count.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func getDataGetList() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_set_shift_book_client_side.url(), parameters: paramDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func getJobRequests()
    {
        ...
        CommunicationManeger.callPostApi(apiUrl: Router.get_client_shift_by_date.url(), parameters: paramDict, parentViewController: self, successBlock: { (responseData, message) in
    ...
    func getUpcomingShifts()
    {
        ...
        CommunicationManeger.callPostApi(apiUrl: Router.get_shift_by_10day_count.url(), parameters: paramDict, parentViewController: self, successBlock: { (responseData, message) in
