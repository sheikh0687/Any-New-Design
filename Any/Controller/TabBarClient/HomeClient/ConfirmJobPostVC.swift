...
extension ConfirmJobPostVC {
    ...
    func WebGetPreviousWorker()
    {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_worker_list_by_jobtype.url(), parameters: paramDict,  parentViewController: self, successBlock: { (responseData, message) in
    ...
    func webSubmit()
    {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.set_shift.url(), parameters: paramJobPostDict,  parentViewController: self, successBlock: { (responseData, message) in
