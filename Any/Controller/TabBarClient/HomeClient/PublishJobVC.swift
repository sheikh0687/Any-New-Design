...
class PublishJobVC: UIViewController {
    ...
    @IBAction func btn_ApplyToAllWorker(_ sender: UIButton) {
        ...
        //            self.strApplyForAllWorker = "No"
        //        } else {
        //            sender.isSelected = true
        //            sender.setImage(#imageLiteral(resourceName: "Checked"), for: .normal)
        //            self.strApplyForAllWorker = "Yes"
        //            self.arrayWorkerTime.removeAll()
        //            self.arrayWorkerTime.append("1")
        //            self.worker_TableVw.reloadData()
        //        }
        if sender.isSelected {
            // Uncheck
    ...
    func isValidInput() -> Bool {
        ...
        } else if shiftType == "SingleDate" && strSingleDate.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
    ...
    //            }
    //        } else if strApplyForAllWorker == "No" {
    //            if workerCount > self.arrayStartTime.count {
    //                isValid = false
    //                errorMessage = "Please Select Start Time"
    //            } else if workerCount > self.arrayEndTime.count {
    //                isValid = false
