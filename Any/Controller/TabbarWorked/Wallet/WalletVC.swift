...
extension WalletVC {
    ...
    func WebGetApprovedBooking() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_shift_complete_by_worker.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
