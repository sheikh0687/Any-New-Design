...
class ChatConversationVC: UIViewController {
    ...
    func getDataGetChatList() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_conversation_detail.url(), parameters: paramDict, parentViewController: self, successBlock: { (responseData, message) in
