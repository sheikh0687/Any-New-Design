...
class NotificationVC: UIViewController {
    ...
    func WebGetCategory() {
        ...
        print(paramsDict)
        CommunicationManeger.callPostService(apiUrl: Router.get_notification_list.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
