...
//                    NotificationCenter.default.post(name: NSNotification.Name("badgeCount"), object: "On Ride", userInfo: notificationData)
    ...
    func WebGetApprovedBooking() {
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_set_shift_book.url(), parameters: paramsDict, parentViewController: self, successBlock: { (responseData, message) in
