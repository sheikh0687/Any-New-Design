...
//        paramDict["client_job_type_id"]  =   "0" as AnyObject
        ...
        CommunicationManeger.callPostService(apiUrl: Router.get_fav_client_list.url(), parameters: paramDict, parentViewController: self, successBlock: { (responseData, message) in
